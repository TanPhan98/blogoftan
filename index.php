...
$num = (int)file_get_contents("images/upload/count_visitors.txt");
if (empty($_SESSION['visitor'])) { 
	$file = fopen("images/upload/count_visitors.txt", "w+");
	$txt = $num + 1;
	fwrite($file, $txt);
	fclose($file);
							...
							<div class="col-md-4">
								<div class="blog-entry ftco-animate">
									...
									<div class="text text-2 pt-2 mt-3">
										...
										$cate->read_single();
										?>
										<span class="category mb-3 d-block"><a href="blog_categories.php?id=<?php echo $rows['n_category_id'] ?>"><?php echo $cate->v_category_title; ?></a></span>
