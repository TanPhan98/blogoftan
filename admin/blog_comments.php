    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-toggle="modal" data-target="#delete_comment<?php echo $rows['n_blog_comment_id'] ?>">Delete</button>
                                                        </td>
                                                    </tr>
                                            <?php
                                                }
            ...
            if ($num > 0) {
                while ($rows = $result->fetch()) {
            ?>
                    <div class="modal fade" id="delete_comment<?php echo $rows['n_blog_comment_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <form role="form" method="POST" action="">
                                    ...
                                    <div class="modal-body">
                                        <h3>Bạn có muốn xóa Comment này không ?</h3>
                                    </div>
